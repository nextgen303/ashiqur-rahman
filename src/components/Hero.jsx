    ...
    >
      <div className="max-w-screen-2xl px-20 max-xl:px-10 max-sm:!px-3 mx-auto">
        <div className="main flex flex-col items-center justify-center gap-4 pt-20 relative">
          ...
          <h1 className="font-custom text-[10vw] max-md:text-[7vw] leading-[180px]">
            Web Designer{" "}
          </h1>
          <h1 className=" text-[10vw] leading-[100px] max-md:text-[7vw]  font-black font-custom">
            {" "}
          ...
          <div className="absolute -right-24 top-0 -z-20">
              <img src={Bgone} className="w-full h-full object-cover" alt="" />
          </div>

          <div className="absolute right-24 -bottom-36">
          <img src={Bgtwo}  className="w-full h-full object-cover" alt="" />
          </div>
        </div>
      </div>
    </div>
