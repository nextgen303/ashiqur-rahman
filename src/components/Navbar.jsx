...
const Navbar = () => {
  return (
    <nav
     className="max-w-screen-2xl bg-[#eaeaea]  px-20 max-sm:!px-3 max-xl:px-10  mx-auto flex items-center justify-between py-2 relative transition-transform duration-300 z-50">
      <a href="/" className="brightness-0">
        <svg
          className="w-10 max-md:w-9"
