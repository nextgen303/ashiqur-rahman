...
const Navbar = () => {
  ...
  return (
    <nav className="max-w-screen-2xl bg-[#F3F3F5] text-black px-20 max-sm:!px-3 max-xl:px-10 mx-auto py-3 max-md:py-2 relative transition-transform duration-300 z-40">
